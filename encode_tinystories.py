...
encode_file_path = "data/TinyStoriesV2-GPT4-train.txt"
output_text_path = "encode/TinyStoriesV2-GPT4-train-encoded.txt"
output_bin_path = "encode/TinyStoriesV2-GPT4-train-encoded.bin"
...
if __name__ == "__main__":
    ...
    # - 每个 token 只占 2 bytes
    print("Writing binary format (int32)...")
